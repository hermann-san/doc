...
- either using the tricks lister [here](/admin/install/post_install/find_ip)
...
<img src="/static/img/providers/ip_serveur.png" width="800"/>

#### Configure SFR box's DNS

Go to Network tab > DNS and add your domain name to the box's DNS.
<img src="/static/img/providers/dns_9box.png" width="800"/>
